  ...
  return (
    <div className="report-page">
      <style>{`
        ...
        .form-group select:focus { border-color: #3b82f6; box-shadow: 0 0 0 3px rgba(59,130,246,0.15); background-color: #ffffff; }
...
/* Submit button — bold, large, eye-catching */
      ...
      <form onSubmit={handleSubmit} className="report-form">
        <div className="form-section">
          <div className="form-group">
            ...
            <input type="text" name="title" placeholder="Brief description of the issue" value={formData.title} onChange={handleChange} required />
          </div>
          <div className="form-group">
            <label>Detailed Description *</label>
            <textarea name="description" placeholder="Provide detailed information about the issue" value={formData.description} onChange={handleChange} required />
          </div>
        </div>
        ...
        <div className="notes">
          ...
          <ul>
            ...
            <li>You will receive notifications about the status of your report</li>
          </ul>
        </div>
